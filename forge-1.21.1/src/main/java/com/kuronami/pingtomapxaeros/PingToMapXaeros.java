...
/**
 * Ping to Map: Xaero's edition (Forge 1.21.1, CLIENT only).
 *
 * <p>Ping-Wheel で受信した ping を Xaero's Minimap / World Map の
 * 一時 waypoint として「副次的・プロンプトなし・30 秒で自動消滅」で立てる。
 *
 * <p>Forge 1.21.1 の {@code @Mod} は value のみ。CLIENT 限定は mods.toml の
...
public class PingToMapXaeros {
    ...
    public PingToMapXaeros() {
        ...
        LOGGER.info("Ping to Map: Xaero's edition (Forge 1.21.1) initialized");
    }
}
